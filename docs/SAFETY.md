...
5. Source `scripts/hardware_env.sh` and verify passive telemetry with
   `hardware_telemetry.launch.py` before stopping it and considering the
   separately gated `hardware_motion.launch.py`.
