...
forward-only guard to `/g1/motion_cmd_vel`, accepts paths of at least 0.10 m
without an accumulated-turn limit, and still starts `/g1/control_enabled=false`. It does not
